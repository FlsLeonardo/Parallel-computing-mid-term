...
file_path = "../output/Omp.csv"  # Sostituisci con il percorso corretto del file
...
output_pdf_path = "../output/transpose_time_vs_matrix_size_Omp_32threads.pdf"  # Percorso del file PDF di output
